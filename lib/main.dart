import 'package:expense_tracker/pages/chave_pix_atualizar.dart';
import 'package:expense_tracker/pages/chave_pix_cadastro.dart';
import 'package:expense_tracker/pages/chaves_pix_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "/chaves-pix": (context) => const ChavePixPage(),
        "/chave-pix-cadastro": (context) => const ChavePixCadastro(),
        "/chave-pix-atualizar": (context) => const ChavePixAtualizar(),
      },
      initialRoute: "/splash",
    );
  }
